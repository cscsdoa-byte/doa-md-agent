...
export const CHANNEL_THEME: Record<string, ChannelTheme> = {
  ...
  k_shopping:               { abbr: "K쇼",  label: "K쇼핑",          bold: "text-pink-700" },
  lotte_homeshopping:       { abbr: "롯데", label: "롯데홈쇼핑",      bold: "text-red-800" },
  homeshopping_moa:         { abbr: "모아", label: "홈쇼핑모아",      bold: "text-amber-700" },
  gongyoung_homeshopping:   { abbr: "공영", label: "공영홈쇼핑",      bold: "text-teal-700" },
  cj_onstyle:               { abbr: "CJ",  label: "CJ온스타일",      bold: "text-violet-800" },
  shinsegae_homeshopping:   { abbr: "신세", label: "신세계홈쇼핑",    bold: "text-rose-800" },
