...
export const CS_MANUAL: CsManualItem[] = [
  ...
  },
  {
    ...
    reply_templates: [
      ...
      {
        label: "상품 불량 환불",
        text: "정말 죄송합니다 ㅠㅠ\n불편 드린 상품 사진 한 장만 보내주시면\n즉시 재발송 또는 환불 처리해드릴게요!\n다시 한번 사과드립니다.",
      },
      {
        label: "단순 변심 — 정책 안내",
        text: "고객님, 안내드릴게요.\n신선식품 특성상 제조가 시작된 이후에는 변심에 의한 환불이 어려운 점\n양해 부탁드릴게요 ㅠㅠ\n혹시 다른 사유가 있으시면 말씀 주세요.",
      },
    ],
  ...
  },
  {
    ...
    reply_templates: [
      ...
      {
        label: "취소 불가 (제조 시작 후)",
        text: "고객님, 안내드릴게요.\n주문하신 떡은 이미 정성껏 제조 중이라\n취소가 어려운 점 양해 부탁드릴게요 ㅠㅠ\n혹시 불편하신 부분 있으시면 말씀 주세요.",
      },
    ],
    policy_notes: [
  ...
  },
  {
    ...
    reply_templates: [
      {
        label: "사유 확인 — 사진 요청",
        text: "고객님 불편을 드려 죄송합니다 ㅠㅠ\n\n상품 사진 한 장만 보내주시면\n어떤 문제인지 확인 후 빠르게 처리해드릴게요.",
      },
      {
        label: "재발송 — 공장 책임",
  ...
  },
  {
    ...
    reply_templates: [
      {
        label: "사과 + 사진 요청",
        text: "고객님, 정말 죄송합니다 ㅠㅠ\n\n저희가 정성껏 보내드린 상품에 문제가 있어서\n드리는 사과의 말씀이 부족할 것 같아요.\n\n상품 사진 한 장만 보내주시면\n즉시 재발송 또는 환불 도와드릴게요.",
      },
      {
        label: "재발송 결정 + 사과",
        text: "확인되었습니다, 고객님.\n바로 새 상품으로 재발송 도와드릴게요.\n발송되면 송장번호 별도 안내드릴게요!\n\n앞으로 검수 더 꼼꼼히 챙기겠습니다.\n불편 드려 정말 죄송합니다 ㅠㅠ",
  ...
  },
  {
    ...
    reply_templates: [
      {
        label: "사과 + 추적 안내",
        text: "고객님, 배송 지연으로 불편 드려 정말 죄송합니다 ㅠㅠ\n\n성함과 연락처 뒷자리 4자리 알려주시면\n바로 택배사 추적해서 정확한 도착 예정일 안내드릴게요!",
      },
      {
        label: "택배사 사유 — 보상 안내",
        text: "확인해보니 택배사 사정으로 지연되고 있어요 ㅠㅠ\n예상 도착일은 #{도착일}이에요.\n\n지연에 대한 사과의 의미로 #{쿠폰/할인} 보내드렸어요.\n다시 한번 양해 부탁드릴게요 ^^",
      },
    ],
    policy_notes: [
  ...
  },
  {
    ...
    reply_templates: [
      {
        label: "진심 사과 + 즉시 응대",
        text: "고객님, 정말 정말 죄송합니다 ㅠㅠ\n\n저희가 부족해서 이렇게 불편 드린 점\n진심으로 사과드릴게요.\n\n어떤 부분이 문제였는지 자세히 알려주시면\n즉시 확인하고 최선을 다해 처리해드릴게요.",
      },
      {
        label: "상담사 직접 연결",
